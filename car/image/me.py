...
# print('sorted_array, ', contours_sorted_by_x)
...
def add_rectangle_contours(diff_x, diff_y):
    ...
    for i in range(len(diff_x)):
        ...
        is_rectangle_flag = diff_x_arithmetic.count(0) / len(diff_x_arithmetic) > 0.8
        # print(diff_x_arithmetic.count(0) / len(diff_x_arithmetic))
        is_rectangle_flag = (diff_y_arithmetic.count(0) / len(diff_y_arithmetic) > 0.8) and is_rectangle_flag
        # print(diff_y_arithmetic.count(0) / len(diff_y_arithmetic))
...
# print('ans', rectangle_contours)
for contour in rectangle_contours:
    cv2.circle(original_image, (contour[0], contour[1]), 2, (50,255,0), -1)
